...
function Score(props){
    ...
    return(
        <div className="score container w-1/2 flex items-center justify-between rounded-2xl bg-white">
            <div className="flex items-center justify-center gap-5">
                <span className="icon flex items-center justify-center rounded-full">
            ...
            <div className="score-percentage flex flex-col items-center gap-3 border-l-2 border-neutral-200">
