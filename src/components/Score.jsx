...
function Score(props){
    ...
    return(
        <div className="shadow py-5 px-10 my-5 mx-auto w-[calc(100%-3rem)] sm:w-[calc(100%-5rem)] lg:w-1/2 flex flex-col sm:flex-row gap-5 sm:gap-0 items-center justify-between rounded-2xl bg-white">
            ...
            <div className="pl-10 flex flex-col items-center gap-3 sm:border-l-2 border-neutral-200">
